...
wget https://yonghwi-kwon.github.io/class/enee457/pin/pin-3.28-98749-g6643ecee5-gcc-linux.tar.gz
...
wget https://yonghwi-kwon.github.io/class/enee457/script/pin.env
echo "cd $PWD" >> ~/.bashrc
